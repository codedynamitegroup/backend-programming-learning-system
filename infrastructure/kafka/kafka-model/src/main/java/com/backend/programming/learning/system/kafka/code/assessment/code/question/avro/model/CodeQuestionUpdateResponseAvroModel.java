...
public class CodeQuestionUpdateResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2890315194149261098L;
  ...
  private static final BinaryMessageEncoder<CodeQuestionUpdateResponseAvroModel> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<CodeQuestionUpdateResponseAvroModel> DECODER =
   ...
   */
  public static BinaryMessageEncoder<CodeQuestionUpdateResponseAvroModel> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<CodeQuestionUpdateResponseAvroModel> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<CodeQuestionUpdateResponseAvroModel> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this CodeQuestionUpdateResponseAvroModel to a ByteBuffer.
  ...
  /**
   * Deserializes a CodeQuestionUpdateResponseAvroModel from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a CodeQuestionUpdateResponseAvroModel instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static CodeQuestionUpdateResponseAvroModel fromByteBuffer(
   ...
   */
  public CodeQuestionUpdateResponseAvroModel(java.util.UUID id, java.util.UUID codeQuestionId, java.util.UUID sagaId, java.util.UUID questionId, java.lang.String problemStatement, java.lang.Float maxGrade, java.lang.String name, java.lang.Boolean isPublic, java.lang.Boolean allowImport, com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CopyState copyState, java.util.List<java.lang.String> failureMessages) {
    this.id = id;
  ...
  public java.lang.Object get(int field$) {
    ...
    case 10: return failureMessages;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 10: failureMessages = (java.util.List<java.lang.String>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  /**
   * Creates a new CodeQuestionUpdateResponseAvroModel RecordBuilder.
   * @return A new CodeQuestionUpdateResponseAvroModel RecordBuilder
   */
  public static com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder newBuilder() {
    return new com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder();
  }

  /**
   * Creates a new CodeQuestionUpdateResponseAvroModel RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new CodeQuestionUpdateResponseAvroModel RecordBuilder
   */
  public static com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder newBuilder(com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder other) {
    if (other == null) {
      return new com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder();
    } else {
      return new com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder(other);
    }
  }

  /**
   * Creates a new CodeQuestionUpdateResponseAvroModel RecordBuilder by copying an existing CodeQuestionUpdateResponseAvroModel instance.
   * @param other The existing instance to copy.
   * @return A new CodeQuestionUpdateResponseAvroModel RecordBuilder
   */
  public static com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder newBuilder(com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel other) {
    if (other == null) {
      return new com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder();
    } else {
      return new com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder(other);
  ...
  /**
   * RecordBuilder for CodeQuestionUpdateResponseAvroModel instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CodeQuestionUpdateResponseAvroModel>
    implements org.apache.avro.data.RecordBuilder<CodeQuestionUpdateResponseAvroModel> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[10], other.failureMessages)) {
        this.failureMessages = data().deepCopy(fields()[10].schema(), other.failureMessages);
        fieldSetFlags()[10] = other.fieldSetFlags()[10];
      }
    }

    /**
     * Creates a Builder by copying an existing CodeQuestionUpdateResponseAvroModel instance
     * @param other The existing instance to copy.
     */
    private Builder(com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder setCodeQuestionId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder clearCodeQuestionId() {
      codeQuestionId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder setQuestionId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder clearQuestionId() {
      questionId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder setProblemStatement(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder clearProblemStatement() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder setIsPublic(java.lang.Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder clearIsPublic() {
      isPublic = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder setAllowImport(java.lang.Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.code.assessment.code.question.avro.model.CodeQuestionUpdateResponseAvroModel.Builder clearAllowImport() {
      allowImport = null;
    ...
    public CodeQuestionUpdateResponseAvroModel build() {
      try {
        CodeQuestionUpdateResponseAvroModel record = new CodeQuestionUpdateResponseAvroModel();
        ...
        record.failureMessages = fieldSetFlags()[10] ? this.failureMessages : (java.util.List<java.lang.String>) defaultValue(fields()[10]);
        return record;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<CodeQuestionUpdateResponseAvroModel>
    WRITER$ = (org.apache.avro.io.DatumWriter<CodeQuestionUpdateResponseAvroModel>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<CodeQuestionUpdateResponseAvroModel>
    READER$ = (org.apache.avro.io.DatumReader<CodeQuestionUpdateResponseAvroModel>)MODEL$.createDatumReader(SCHEMA$);
