...
public class OrganizationResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4181468499279748412L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrganizationResponseAvroModel\",\"namespace\":\"com.backend.programming.learning.system.kafka.auth.avro.model.organization\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"sagaId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"organizationId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"serviceName\",\"type\":{\"type\":\"enum\",\"name\":\"ServiceName\",\"symbols\":[\"CORE_SERVICE\",\"AUTH_SERVICE\",\"COURSE_SERVICE\",\"CODE_ASSESSMENT_SERVICE\",\"BACKGROUND_SERVICE\"]}},{\"name\":\"copyState\",\"type\":{\"type\":\"enum\",\"name\":\"CopyState\",\"symbols\":[\"CREATING\",\"CREATED\",\"UPDATING\",\"UPDATED\",\"DELETING\",\"DELETED\",\"DELETE_FAILED\",\"UPDATE_FAILED\",\"CREATE_FAILED\"]}},{\"name\":\"failureMessages\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}}]}");
   ...
   */
  public OrganizationResponseAvroModel(java.lang.String id, java.lang.String sagaId, java.lang.String organizationId, com.backend.programming.learning.system.kafka.auth.avro.model.organization.ServiceName serviceName, com.backend.programming.learning.system.kafka.auth.avro.model.organization.CopyState copyState, java.util.List<java.lang.String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: serviceName = (com.backend.programming.learning.system.kafka.auth.avro.model.organization.ServiceName)value$; break;
    case 4: copyState = (com.backend.programming.learning.system.kafka.auth.avro.model.organization.CopyState)value$; break;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrganizationResponseAvroModel>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.auth.avro.model.organization.OrganizationResponseAvroModel.Builder setServiceName(com.backend.programming.learning.system.kafka.auth.avro.model.organization.ServiceName value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.auth.avro.model.organization.OrganizationResponseAvroModel.Builder clearServiceName() {
      serviceName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.auth.avro.model.organization.OrganizationResponseAvroModel.Builder setCopyState(com.backend.programming.learning.system.kafka.auth.avro.model.organization.CopyState value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.auth.avro.model.organization.OrganizationResponseAvroModel.Builder clearCopyState() {
      copyState = null;
    ...
    public OrganizationResponseAvroModel build() {
      try {
        ...
        record.serviceName = fieldSetFlags()[3] ? this.serviceName : (com.backend.programming.learning.system.kafka.auth.avro.model.organization.ServiceName) defaultValue(fields()[3]);
        record.copyState = fieldSetFlags()[4] ? this.copyState : (com.backend.programming.learning.system.kafka.auth.avro.model.organization.CopyState) defaultValue(fields()[4]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.serviceName = com.backend.programming.learning.system.kafka.auth.avro.model.organization.ServiceName.values()[in.readEnum()];

      this.copyState = com.backend.programming.learning.system.kafka.auth.avro.model.organization.CopyState.values()[in.readEnum()];
