...
public class CalendarEventUpdateResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<CalendarEventUpdateResponseAvroModel> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<CalendarEventUpdateResponseAvroModel> DECODER =
   ...
   */
  public static BinaryMessageEncoder<CalendarEventUpdateResponseAvroModel> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<CalendarEventUpdateResponseAvroModel> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<CalendarEventUpdateResponseAvroModel> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this CalendarEventUpdateResponseAvroModel to a ByteBuffer.
  ...
  /**
   * Deserializes a CalendarEventUpdateResponseAvroModel from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a CalendarEventUpdateResponseAvroModel instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static CalendarEventUpdateResponseAvroModel fromByteBuffer(
  ...
  private com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.UpdateState updateCalendarEventState;
   ...
   */
  public CalendarEventUpdateResponseAvroModel() {}
  ...
  public java.lang.Object get(int field$) {
    ...
    case 11: return updateCalendarEventState;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: courseId = (java.util.UUID)value$; break;
    case 5: name = value$ != null ? value$.toString() : null; break;
    case 6: description = value$ != null ? value$.toString() : null; break;
    case 7: eventType = (com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.NotificationEventType)value$; break;
    case 8: startTime = (java.time.Instant)value$; break;
    case 9: endTime = (java.time.Instant)value$; break;
    case 10: component = (com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.NotificationComponentType)value$; break;
    case 11: updateCalendarEventState = (com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.UpdateState)value$; break;
  ...
  /**
   * Gets the value of the 'updateCalendarEventState' field.
   * @return The value of the 'updateCalendarEventState' field.
   */
  public com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.UpdateState getUpdateCalendarEventState() {
    return updateCalendarEventState;
  }


  /**
   * Sets the value of the 'updateCalendarEventState' field.
   * @param value the value to set.
   */
  public void setUpdateCalendarEventState(com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.UpdateState value) {
  ...
  /**
   * Creates a new CalendarEventUpdateResponseAvroModel RecordBuilder.
   * @return A new CalendarEventUpdateResponseAvroModel RecordBuilder
   */
  public static com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.CalendarEventUpdateResponseAvroModel.Builder newBuilder() {
    return new com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.CalendarEventUpdateResponseAvroModel.Builder();
  }

  /**
   * Creates a new CalendarEventUpdateResponseAvroModel RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new CalendarEventUpdateResponseAvroModel RecordBuilder
   */
  public static com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.CalendarEventUpdateResponseAvroModel.Builder newBuilder(com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.CalendarEventUpdateResponseAvroModel.Builder other) {
    if (other == null) {
      return new com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.CalendarEventUpdateResponseAvroModel.Builder();
    } else {
      return new com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.CalendarEventUpdateResponseAvroModel.Builder(other);
    }
  }

  /**
   * Creates a new CalendarEventUpdateResponseAvroModel RecordBuilder by copying an existing CalendarEventUpdateResponseAvroModel instance.
   * @param other The existing instance to copy.
   * @return A new CalendarEventUpdateResponseAvroModel RecordBuilder
   */
  public static com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.CalendarEventUpdateResponseAvroModel.Builder newBuilder(com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.CalendarEventUpdateResponseAvroModel other) {
    if (other == null) {
      return new com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.CalendarEventUpdateResponseAvroModel.Builder();
    } else {
      return new com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.CalendarEventUpdateResponseAvroModel.Builder(other);
  ...
  /**
   * RecordBuilder for CalendarEventUpdateResponseAvroModel instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CalendarEventUpdateResponseAvroModel>
    implements org.apache.avro.data.RecordBuilder<CalendarEventUpdateResponseAvroModel> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.CalendarEventUpdateResponseAvroModel.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[4], other.courseId)) {
        this.courseId = data().deepCopy(fields()[4].schema(), other.courseId);
      ...
      if (isValidValue(fields()[10], other.component)) {
        this.component = data().deepCopy(fields()[10].schema(), other.component);
        fieldSetFlags()[10] = other.fieldSetFlags()[10];
      }
      if (isValidValue(fields()[11], other.updateCalendarEventState)) {
        this.updateCalendarEventState = data().deepCopy(fields()[11].schema(), other.updateCalendarEventState);
    ...
    /**
     * Creates a Builder by copying an existing CalendarEventUpdateResponseAvroModel instance
     * @param other The existing instance to copy.
     */
    private Builder(com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.CalendarEventUpdateResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.CalendarEventUpdateResponseAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.CalendarEventUpdateResponseAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.CalendarEventUpdateResponseAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.CalendarEventUpdateResponseAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      * Sets the value of the 'updateCalendarEventState' field.
      * @param value The value of 'updateCalendarEventState'.
      * @return This builder.
      */
    ...
    /**
      * Checks whether the 'updateCalendarEventState' field has been set.
    ...
    /**
      * Clears the value of the 'updateCalendarEventState' field.
      * @return This builder.
      */
    ...
    public CalendarEventUpdateResponseAvroModel build() {
      try {
        ...
        record.courseId = fieldSetFlags()[4] ? this.courseId : (java.util.UUID) defaultValue(fields()[4]);
        ...
        record.eventType = fieldSetFlags()[7] ? this.eventType : (com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.NotificationEventType) defaultValue(fields()[7]);
        record.startTime = fieldSetFlags()[8] ? this.startTime : (java.time.Instant) defaultValue(fields()[8]);
        record.endTime = fieldSetFlags()[9] ? this.endTime : (java.time.Instant) defaultValue(fields()[9]);
        record.component = fieldSetFlags()[10] ? this.component : (com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.NotificationComponentType) defaultValue(fields()[10]);
        record.updateCalendarEventState = fieldSetFlags()[11] ? this.updateCalendarEventState : (com.backend.programming.learning.system.kafka.core.calendar.event.avro.model.UpdateState) defaultValue(fields()[11]);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<CalendarEventUpdateResponseAvroModel>
    WRITER$ = (org.apache.avro.io.DatumWriter<CalendarEventUpdateResponseAvroModel>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<CalendarEventUpdateResponseAvroModel>
    READER$ = (org.apache.avro.io.DatumReader<CalendarEventUpdateResponseAvroModel>)MODEL$.createDatumReader(SCHEMA$);
