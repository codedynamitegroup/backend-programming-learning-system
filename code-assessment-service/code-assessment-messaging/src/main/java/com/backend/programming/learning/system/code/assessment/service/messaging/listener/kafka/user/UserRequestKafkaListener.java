package com.backend.programming.learning.system.code.assessment.service.messaging.listener.kafka.user;
...
public class UserRequestKafkaListener implements KafkaConsumer<UserRequestAvroModel> {
    ...
    @Override
    @KafkaListener(id = "${kafka-consumer-config.code-assessment-service-user-request-group-id}",
            topics = "${code-assessment-service.code-assessment-user-request-topic-name}")
        ...
        messages.forEach(userRequestAvroModel -> {
            try {
                ...
                if (sqlException != null && sqlException.getSQLState() != null &&
                    ...
                    throw new CodeAssessmentServiceApplicationServiceException("Throwing DataAccessException in" +
