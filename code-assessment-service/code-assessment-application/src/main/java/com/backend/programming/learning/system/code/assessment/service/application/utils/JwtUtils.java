package com.backend.programming.learning.system.code.assessment.service.application.utils;
...
public class JwtUtils {
    public static JsonObject getPayloadFromJwtString(String jwtString) {
        ...
        try {
            ...
            throw new CodeAssessmentDomainException("Error while converting jwt payload to json object");
        }
