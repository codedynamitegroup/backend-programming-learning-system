...
public class QuestionOutboxHelper {
    ...
    public QuestionOutboxHelper(QuestionOutboxRepository questionOutboxRepository, ObjectMapper objectMapper) {
    ...
    public void saveQuestionOutboxMessage(QuestionOutboxMessage questionOutboxMessage) {
        ...
        if (response == null) {
            ...
            throw new CodeAssessmentDomainException("Failed to save question outbox message with id: " + questionOutboxMessage.getId());
        }
    ...
    public void saveNewQuestionOutboxMessage(QuestionEventPayload questionEventPayload, CopyState copyState, OutboxStatus outboxStatus, UUID sagaId) {
        questionOutboxRepository.save(QuestionOutboxMessage.builder()
                ...
                .processedAt(questionEventPayload.getCreatedAt())
    ...
    private String createPayload(QuestionEventPayload questionEventPayload) {
        try {
            ...
            throw new CodeAssessmentDomainException("Failed to create payload object for question event: " + questionEventPayload, e);
        }
    }
}
