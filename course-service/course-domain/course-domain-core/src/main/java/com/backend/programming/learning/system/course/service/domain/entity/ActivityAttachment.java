...
public class ActivityAttachment extends AggregateRoot<ActivityAttachmentId> {
    ...
    private ActivityAttachment(Builder builder) {
    ...
    public static final class Builder {
        private ActivityAttachmentId id;
        private Assignment assignment;
        private String fileName;
        private Integer fileSize;
        private ZonedDateTime timemodified;
        ...
        public Builder id(ActivityAttachmentId val) {
            id = val;
            return this;
        }
        ...
        public ActivityAttachment build() {
            return new ActivityAttachment(this);
        }
    }
}
