...
import com.backend.programming.learning.system.course.service.domain.event.organization.OrganizationCreatedSuccessEvent;
...
@Component
@Slf4j
public class CreatedSuccessOrganizationKafkaMessagePublisher implements OrganizationCreatedSuccessMessagePublisher {
    ...
    public CreatedSuccessOrganizationKafkaMessagePublisher(OrganizationMessagingDataMapper organizationMessagingDataMapper,
    ...
    @Override
    public void publish(OrganizationCreatedSuccessEvent domainEvent) {
        ...
        try {
            OrganizationResponseAvroModel organizationResponseAvroModel =organizationMessagingDataMapper
                    .organizationCreatedSuccessEventToOrganizationResponseAvroModel(domainEvent);
