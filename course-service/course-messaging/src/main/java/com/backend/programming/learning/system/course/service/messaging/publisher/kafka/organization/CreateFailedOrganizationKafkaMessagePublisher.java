...
@Component
@Slf4j
public class CreateFailedOrganizationKafkaMessagePublisher implements OrganizationCreateFailedMessagePublisher {
    ...
    public CreateFailedOrganizationKafkaMessagePublisher(OrganizationMessagingDataMapper organizationMessagingDataMapper,
    ...
    @Override
    public void publish(OrganizationCreatedFailEvent domainEvent) {
        ...
        try {
            OrganizationResponseAvroModel organizationResponseAvroModel =organizationMessagingDataMapper
                    .organizationCreatedFailEventToOrganizationResponseAvroModel(domainEvent);
