...
public class CreateFailedUserKafkaMessagePublisher implements UserCreateFailedMessagePublisher {
    ...
    public CreateFailedUserKafkaMessagePublisher(UserMessagingDataMapper userMessagingDataMapper, CourseServiceConfigData courseServiceConfigData, KafkaProducer<String, UserResponseAvroModel> kafkaProducer, KafkaMessageHelper userKafkaMessageHelper) {
