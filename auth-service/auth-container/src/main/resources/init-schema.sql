...
CREATE TABLE "public".main_user (
	...
	is_linked_with_system_account boolean DEFAULT true,
	email_linked_google character varying DEFAULT NULL,
	email_linked_microsoft character varying DEFAULT NULL,
	created_at TIMESTAMP WITH TIME ZONE,
	updated_at TIMESTAMP WITH TIME ZONE,
	is_deleted boolean NOT NULL DEFAULT false,
