...
public class UserOutboxScheduler implements OutboxScheduler {
    ...
    public UserOutboxScheduler(UserOutboxHelper userOutboxHelper, UserRequestMessagePublisher userRequestMessagePublisher) {
        this.userOutboxHelper = userOutboxHelper;
        this.userRequestMessagePublisher = userRequestMessagePublisher;
    }
    ...
    public void processOutboxMessage() {
        ...
        if (outboxMessagesResponse.isPresent() && outboxMessagesResponse.get().size() > 0) {
            ...
            outboxMessages.forEach(outboxMessage ->
                    userRequestMessagePublisher.publish(outboxMessage, this::updateOutboxStatus));
