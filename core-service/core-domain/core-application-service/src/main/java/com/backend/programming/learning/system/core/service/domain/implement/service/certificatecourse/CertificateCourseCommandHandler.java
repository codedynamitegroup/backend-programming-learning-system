...
public class CertificateCourseCommandHandler {
    ...
    public QueryAllCertificateCourseWithPageResponse queryAllCertificateCoursesAdmin(
        ...
        return certificateCourseQueryHelper.queryAllCertificateCourse(
                queryAllCertificateCourseWithPageCommand.pageNo(),
                queryAllCertificateCourseWithPageCommand.pageSize(),
                queryAllCertificateCourseWithPageCommand.searchName());
    }
}
