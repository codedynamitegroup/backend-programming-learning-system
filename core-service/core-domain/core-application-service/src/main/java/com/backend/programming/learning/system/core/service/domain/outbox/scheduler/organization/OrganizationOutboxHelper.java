package com.backend.programming.learning.system.core.service.domain.outbox.scheduler.organization;
...
public class OrganizationOutboxHelper {
    ...
    private String createdPayload(OrganizationEventPayload organizationEventPayload) {
        try {
            ...
            throw new CoreDomainException("Could not create OrganizationEventPayload json!", e);
        }
    }
    ...
    private void save(OrganizationOutboxMessage organizationOutboxMessage) {
        ...
        if (response == null) {
            ...
            throw new CoreDomainException("Could not save OrganizationOutboxMessage!");
        }
